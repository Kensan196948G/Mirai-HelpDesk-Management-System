...
function renderTopNavMenu() {
  ...
  let html = '<div class="nav-accordion-container">';
  ...
  const accordionContainer = nav.querySelector('.nav-accordion-container');
  ...
  accordionContainer.addEventListener('click', (e) => {
    ...
    if (link) {
      ...
      navigateTo(pageId);
      // すべてのメニューを閉じる
      document.querySelectorAll('.nav-accordion-item.active').forEach(item => {
